...
import { BarChart3, CalendarDays, HeartPulse, LayoutDashboard, MonitorUp, Settings } from "lucide-react";
...
const navItems = [
  ...
  { to: "/screen-golf", label: { ko: "스크린골프", en: "Screen Golf" }, icon: MonitorUp },
